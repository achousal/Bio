...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'textAlign': 'left', 'color': '#503D36', 'font-size': '24px'}),
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(id='dropdown-statistics', 
                  ...
                  style={'width': '80%','padding' : '3px','textAlign': 'center','color': '#503D36', 'font-size': '20px'})
    ]),
    html.Div(dcc.Dropdown(
    id='select-year',  # The ID of the Dropdown component
    options=[{'label': i, 'value': i} for i in year_list],  # Options for the dropdown, generated dynamically
    placeholder='Select Year',
    value='Select Year',  # Placeholder text shown when no option is selected
    style={
        'width': '80%',  # Width of the dropdown
        'padding': '3px',  # Padding around the dropdown
        'textAlign': 'center',  # Text alignment within the dropdown
...
# Creating the bar chart
        R_chart4 = dcc.Graph(
            figure=px.bar(unemp_rate,
                x='Vehicle_Type',
                y='Automobile_Sales',
                color='unemployment_rate',  # Color by unemployment rate
                ...
                barmode='group')  # Group bars by vehicle type
        )
